...
LetiFramework.Ui.dnd = function(game) {}

LetiFramework.Ui.dnd.prototype = {
	init: function() {
		LetiFramework.Analytics.trackPage("DnD");
		this.screenConfig = LetiFramework.GameController.screensConfig.dnd;
